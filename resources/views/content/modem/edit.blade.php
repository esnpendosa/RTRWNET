                ...
                <form action="{{ route('modem.update', $modem) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $modem->image_path_front) }}"
                                     style="max-height:150px;border-radius:10px;border:1px solid #e8eaed;" alt="Current Front">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $modem->image_path_back) }}"
                                     style="max-height:150px;border-radius:10px;border:1px solid #e8eaed;" alt="Current Back">
                                <small class="d-block text-muted mt-1">Gambar saat ini. Upload baru untuk mengganti.</small>
                            </div>
                            @endif
