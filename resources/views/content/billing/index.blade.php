    ...
    <div class="card-body pt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex align-items-center">
                <form action="{{ route('billing.index') }}" method="GET" class="me-2">
                    @if(request('status'))
                ...
                <form action="{{ route('billing.delete-all') }}" method="POST" class="me-2" onsubmit="return confirm('Apakah Anda yakin ingin menghapus SEMUA data tagihan? Tindakan ini tidak dapat dibatalkan.')">
                    @csrf @method('DELETE')
    ...
    <div class="modal fade" id="modalGenerateTagihan" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('billing.sync') }}" method="GET">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Proses & Generate</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <form action="{{ route('billing.destroy', $t->id_tagihan) }}" method="POST" onsubmit="return confirm('Hapus tagihan ini?')">
                                @csrf @method('DELETE')
