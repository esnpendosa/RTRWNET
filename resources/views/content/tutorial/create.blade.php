...
@section('title', 'Tambah Tutorial Baru')
...
<div class="card border-0 shadow-sm" style="border-radius: 16px;">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold">Tambah Tutorial Baru</h5>
                ...
                <div class="col-lg-8">
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul" id="judul" class="form-control @error('judul') is-invalid @enderror" 
                               value="{{ old('judul') }}" placeholder="Contoh: Cara Reset dan Setting Ulang Modem ZTE F609" required>
                        @error('judul')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="ringkasan" id="ringkasan" rows="3" class="form-control @error('ringkasan') is-invalid @enderror" 
                                  placeholder="Ringkasan singkat isi tutorial yang akan tampil di halaman depan..." max="500">{{ old('ringkasan') }}</textarea>
                        @error('ringkasan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="konten" id="editor-content" class="d-none">{{ old('konten') }}</textarea>
                        @error('konten')
                    ...
                    <div class="p-3 bg-light rounded" style="border: 1px solid #e5e7eb;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="urutan" id="urutan" class="form-control @error('urutan') is-invalid @enderror" 
                                   value="{{ old('urutan', 0) }}" placeholder="Urutan angka">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2 text-center d-none" id="preview-wrapper">
                                <img src="" id="image-preview" class="img-thumbnail" style="max-height: 150px; object-fit: cover;">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary w-100 mb-2">
                            <i class="bx bx-save me-1"></i> Simpan Tutorial
                        </button>
